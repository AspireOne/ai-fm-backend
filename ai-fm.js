...
var TEMP_DIR = path.join(process.cwd(), "ai-fm-temp");
...
Processing song ${index + 1}/${songsToProcess.length}: ${block.yt.title || "Untitled"}`
        ...
        s2.start("Uploading song to server...");
