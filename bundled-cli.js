...
var require_dist = __commonJS({
  "node_modules/.pnpm/@clack+core@0.4.2/node_modules/@clack/core/dist/index.cjs"(exports2) {
    "use strict";
    ...
    (function(C) {
      ...
      t.length = function(E) {
        for (var B = F(E), A = 0, D = 0; D < B.length; D++) A = A + this.characterLength(B[D]);
        return A;
    ...
    function assembleStyles() {
      ...
      for (const [t, F] of Object.entries(styles)) {
        for (const [E, B] of Object.entries(F)) styles[E] = { open: `\x1B[${B[0]}m`, close: `\x1B[${B[1]}m` }, F[E] = styles[E], C.set(B[0], B[1]);
...
`);
    ...
    var settings = { actions: new Set(a$1), aliases: /* @__PURE__ */ new Map([["k", "up"], ["j", "down"], ["h", "left"], ["l", "right"], ["", "cancel"], ["escape", "cancel"]]) };
    function updateSettings(C) {
      for (const t in C) {
        ...
        switch (F) {
          case "aliases": {
            for (const B in E) Object.hasOwn(E, B) && (settings.aliases.has(B) || settings.aliases.set(B, E[B]));
            break;
          }
        }
      }
...
`)), this._prevFrame = t;
    ...
    var m$1 = class extends k {
      constructor(t) {
        super(t, false), n$2(this, "options"), n$2(this, "cursor", 0), h(this, u$3, void 0);
        const { options: F } = t;
    ...
    exports2.ConfirmPrompt = s, exports2.GroupMultiSelectPrompt = m$1, exports2.MultiSelectPrompt = u$2, exports2.PasswordPrompt = m, exports2.Prompt = k, exports2.SelectKeyPrompt = c, exports2.SelectPrompt = u, exports2.TextPrompt = o, exports2.block = block, exports2.isCancel = isCancel2, exports2.updateSettings = updateSettings;
  }
});

// node_modules/.pnpm/@clack+prompts@0.10.1/node_modules/@clack/prompts/dist/index.cjs
var require_dist2 = __commonJS({
  "node_modules/.pnpm/@clack+prompts@0.10.1/node_modules/@clack/prompts/dist/index.cjs"(exports2) {
    "use strict";
...
`;
    ...
    var groupMultiselect = (t) => {
      const { selectableGroups: o = true } = t, s = (i, r, c = []) => {
        ...
        if (r === "active") return `${e__default.dim(m)}${e__default.cyan(C)} ${n} ${i.hint ? e__default.dim(`(${i.hint})`) : ""}`;
        if (r === "group-active") return `${m}${e__default.cyan(C)} ${e__default.dim(n)}`;
        if (r === "group-active-selected") return `${m}${e__default.green(V)} ${e__default.dim(n)}`;
        if (r === "selected") {
        ...
        if (r === "active-selected") return `${e__default.dim(m)}${e__default.green(V)} ${n} ${i.hint ? e__default.dim(`(${i.hint})`) : ""}`;
...
`);
        ...
        const d = (performance.now() - p) / 1e3, v = Math.floor(d / 60), f = Math.floor(d % 60);
...
`), M(), r();
    ...
    exports2.isCancel = core.isCancel, exports2.updateSettings = core.updateSettings, exports2.cancel = cancel, exports2.confirm = confirm, exports2.group = group, exports2.groupMultiselect = groupMultiselect, exports2.intro = intro2, exports2.log = log, exports2.multiselect = multiselect, exports2.note = note2, exports2.outro = outro2, exports2.password = password, exports2.select = select2, exports2.selectKey = selectKey, exports2.spinner = spinner2, exports2.stream = stream, exports2.tasks = tasks, exports2.text = text;
  }
});
...
async function uploadSong(filePath, blockId, radioId, title) {
  try {
    ...
    return new Promise((resolve, reject) => {
      ...
      const req = url.protocol === "https:" ? require("https").request(options) : require("http").request(options);
      req.on("response", (res) => {
        let data = "";
        res.on("data", (chunk) => {
          data += chunk;
...
Processing song ${index + 1}/${songsToProcess.length}: ${block.yt.title || "Untitled"}`
        ...
        s2.start(`Uploading song to server${title ? " with title" : ""}...`);
        await uploadSong(outputPath, block.id, selectedRadio.id, title);
        stats.uploaded++;
        s2.stop("Upload complete");
